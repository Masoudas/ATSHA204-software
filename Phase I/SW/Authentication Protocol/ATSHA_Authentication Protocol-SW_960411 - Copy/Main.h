...
//// I/O port definition
#define         GREEN_LED_PORT_DIRECTION       DDRC
#define         GREEN_LED_PORT_WRITE           PORTC
#define         RED_LED_DIRECTION              DDRD
#define         RED_LED_PORT_WRITE             PORTD
...
PL1_flags                        PL1_output_flag;               // Denotes the output flag of PL1.
PL2_flags                        PL2_output_flag;               // Denotes the output flag of PL2.
...
//// Other variables
command_response_struct          *command_response_pointer;            // Pointer to a structure of this type.
