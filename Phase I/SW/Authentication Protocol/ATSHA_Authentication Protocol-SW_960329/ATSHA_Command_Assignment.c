...
void Assign_WriteCommand_Buffer(command_response_struct *pcommand_response,unsigned char *pdata_string, unsigned char count_byte, unsigned char opcode_byte, unsigned char param1_byte, unsigned char param20_byte, unsigned char param21_byte)
{
  // Initialization
...
void Assign_ReadCommand_Buffer(command_response_struct *pcommand_response, unsigned char count_byte, unsigned char opcode_byte, unsigned char param1_byte, unsigned char param20_byte, unsigned char param21_byte)
{
  // Initialization
