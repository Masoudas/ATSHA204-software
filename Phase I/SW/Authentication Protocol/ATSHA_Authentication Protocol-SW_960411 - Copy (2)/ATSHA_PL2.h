...
/* Note: These registers are those of I2C (see the SANIC report on I2C protocl).
...
#define           WAKE_TOKEN_COMMAND                 0x0F              // Wake ATSHA command to be sent by I2C (which is sent as an address, yet interpretted by ATSHA as a wake token).
                                                                       ...
                                                                       // Why 0x0F? Note that 0x00 is not allowed as an address in I2C (see the report on I2C protocol).
