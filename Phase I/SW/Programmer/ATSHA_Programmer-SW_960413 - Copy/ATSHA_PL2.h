...
#define           WAKE_TOKEN_I2C_FREQUENCY_PRESCALAR 0x01


//// Commands pertained to PL2 and their responses
// wake ATSHA command
#define           WAKE_TOKEN_COMMAND                 0xC8              // Wake ATSHA command to be sent by I2C (which is sent as an address, yet interpretted by ATSHA as a wake token).
