...
#define           WDZ207_DATA109                   (XOR_BYTE01 >> 1)             // The result is 0x02.         
...
//// Other parameters
#define           WDZ_DATA10_OFFSET                0x06                 // The position of the first data byte when writing data to DZ (which is 6 of course!)
#define           RESPONSE_DATA1_OFFSET            0x02                 // The element of the response vector that contains the first data byte (after count and status/error bytes).
