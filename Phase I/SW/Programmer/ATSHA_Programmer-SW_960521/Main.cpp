...
{     
  ...
  switch (current_state)
  {
    case (PROGRAM_ATSHA):     
      ...
      add a counter here to get out of this!
    ...
    case (PROGRAMMING_FAILURE):
      ...
      // Set null commands in the command buffer to ensure that no incorrect command will be sent to ATSHA the next time it is going to be programmed.
