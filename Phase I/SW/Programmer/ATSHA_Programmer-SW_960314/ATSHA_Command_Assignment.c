...
void Assign_WCZ055_Buffer(command_response_struct *command_response)
{
  ...
  (*command_response).command[0] = WCZ055_COMMAND;
  ...
  (*command_response).command[10] = generated_CRC_bytes[0];
  (*command_response).command[11] = generated_CRC_bytes[1];  
}

void Assign_WCZ066_Buffer(command_response_struct *command_response)
{
  // Assigning the command name
  (*command_response).command[0] = WCZ066_COMMAND;
...
{
  // Assigning the command name
  (*command_response).command[0] = LOCKCZ_COMMAND;
  ...
  (*command_response).command[6] = generated_CRC_bytes[0];
...
{
  // Assigning the command name
  (*command_response).command[0] = RCZ007_COMMAND;
...
{
  // Assigning the command name
  (*command_response).command[0] = WDZ007_COMMAND;
  ...
  // Encoding the XOR string to be written to DZ007 (Note that the XOR string bits must be swapped before writing it to DZ007).
...
{
  // Assigning the command name
  (*command_response).command[0] = WDZ107_COMMAND;
  ...
  Encode_Input_Data(&((*command_response).response[6]),32);   // Encoding the serial number bytes.
...
{
  // Assigning the command name
  (*command_response).command[0] = WDZ207_COMMAND;
...
{
  // Assigning the command name
  (*command_response).command[0] = LOCKDZ_COMMAND;
...
{
  // Assigning the command name
  (*command_response).command[0] = RCZ255_COMMAND;
