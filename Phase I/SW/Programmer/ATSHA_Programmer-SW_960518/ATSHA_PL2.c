...
PL2_flags ATSHA_PL2(command_response_struct *pcommand_response, unsigned int current_system_time)
{
     ...
     {     
       ...
       case (CHECK_ATSHA_AWAKE):
         ...
         {
           PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, CHECK_ATSHA_AWAKE, SEND_COMMAND, WAKE_ATSHA);       
         }
         PL2_output_flag = PL2_BUSY;
         break;
       ...
       case (SEND_COMMAND):        
         ...
         PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, SEND_COMMAND, READ_RESPONSE, SEND_COMMAND); // Note that recursion operation is unncessary for this mode.
         PL2_output_flag = PL2_BUSY;
         break; 
       ...
       case (READ_RESPONSE):
         ...
         PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, READ_RESPONSE, (*pcommand_response).sleep_idle, SEND_COMMAND);
       ...
       case (SET_ATSHA_SLEEP):
         ...
         PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, SET_ATSHA_SLEEP, PL2_FINALIZATION, SET_ATSHA_SLEEP);         
       ...
       case (SET_ATSHA_IDLE):
         ...
         I2C_status = I2C_Protocol(&((*pcommand_response).command[0]), 1, I2C_MT_MODE, ATSHA_SLAVE_ADDRESS, IGNORE_CRC, 0x00, 0x00, current_system_time);
         PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, SET_ATSHA_IDLE, PL2_FINALIZATION, SET_ATSHA_IDLE);                  
         PL2_output_flag = PL2_BUSY;      // The protocol is terminated at this point.
         break;
       ...
       case (RESET_ATSHA_BUFFER):
         ...
         PL2_Assign_Operation(I2C_status.output_flag, pcommand_response, RESET_ATSHA_BUFFER, SEND_COMMAND, PL2_RECOVERY_STATUS);     // Recursion operation is unnecessary here.
         PL2_output_flag = PL2_BUSY;
         break;
...
void PL2_Assign_Operation(bool I2C_output_flag, command_response_struct *pcommand_response, unsigned char operation_current, unsigned char operation_next, unsigned char recursion_operation)
{
  // Initialization
  ...
  else if (I2C_output_flag == I2C_PROTOCOL_BUSY) // Else if I2C is still busy receiving information.        
  {
