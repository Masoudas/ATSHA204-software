...
//// General parameters
// Lengths and offsets
#define           MAX_COMMAND_LENGTH                 ??                // The length of the longest command to be sent to ATSHA.
#define           MAX_RESPONSE_LENGTH                ??                // The longest response to be recieved from ATSHA.
