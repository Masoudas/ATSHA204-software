...
#define           GENERATE_CHILD_KEY_1             0x21  
#define           GENERATE_CHILD_KEY_2             0x22                 
...
struct PL1_data_struct{
       ...
       unsigned char        OPD_ROPD[32];                                                  // An array that holds either OPD or ROPD.
       ...
       unsigned char        serial_number[8]                                               // An array that holds ATSHA serial number.
       };
